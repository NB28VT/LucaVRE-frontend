...
test.describe('New Session car/track/symptom selection', () => {
  ...
  test('shows placeholder options in the Car, Track, and Reported Symptom dropdowns by default', async ({
    page,
  }) => {
  ...
  test('lists every mock car, track, and reported symptom as selectable options', async ({
    page,
  }) => {
    const carSelect = page.getByLabel('Car');
    const trackSelect = page.getByLabel('Track');
  ...
  test('retains selected car, track, and reported symptom in local state after navigating away and back', async ({
    page,
  }) => {
    const carSelect = page.getByLabel('Car');
    const trackSelect = page.getByLabel('Track');
